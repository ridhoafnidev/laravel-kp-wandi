              ...
              <table class="table table-striped table-bordered table-hover">
                 <tr>
                  ...
                  <tr>
                      ...
                      <th>
                        <i>
                            Selamat Pemesanan anda sudah selesai, silahkan datang ke kantor Bapeda Rohil<br>
                            dengan membawa bukti selesai pemesanan.
                        </i><br><br>
                        <a href="{{action('ReklameController@downloadPDF', $reklame->id)}}" 
                            class="btn btn-outline btn-primary" 
                            style="padding-bottom: 0px; padding-top:0px;">Cetak 
                            <span class="btn-label btn-label-right"><i class="fa fa-print"></i></span> 
                        </a>
                     </th>
                      <?php
                      }
